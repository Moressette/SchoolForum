...
<body>
    ...
    <div class="titleColor">
        <div class="container">
            <font style="color:#ffffff;font-size:50px;font-family:微软雅黑">用户登出</font>
        </div>
    </div>
    <!--TITLE END-->
	...
	<div class="container">
        ...
        <br>
        <center>
        <font style="font-family:微软雅黑; font-size:52px;"><img style="width:60px;height:60px"src="img/completed.png"/>&nbsp;注销成功</font>
